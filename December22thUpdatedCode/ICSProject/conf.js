...
exports.config = {
   ...
   suites: {
        ...
        Account_Alias_Receipt: ['testCases/Cycle_Count_Manual/Cycle_Count_Manual_Locator.js',
        'testCases/Cycle_Count_Manual/Cycle_Count_Manual_without_Locator.js'],
    

    },

    // A callback function called once configs are read but before any environment
    //Putaway_Receipt //Purchase Order  //CreatePOWithInspectionItemOnly//CreatePOWithDirectReceipt//CreatePOWithInspectionAndStandard//Putaway_Receipt_Standard_Items
    ...
    onPrepare: function () {
        ...
        global.GALLOP_REPORT_DIR = basePath + '/results/ICSFLReport/' + global.SUITENAME + '-' + global.TIMESTAMP + '/';
    ...
    resultJsonOutputFile: './results/ICSFLReport/report_assets/results_output.json'
};